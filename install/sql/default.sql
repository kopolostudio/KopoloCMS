...
--
-- Host: localhost
-- Generation Time: Dec 25, 2011 at 07:02 AM
...
(21, 2, 6, 'Карта сайта', 'content', 22, 0, 1, 1, 0),
(19, 2, 5, 'Поиск', 'content', 20, 0, 6, 1, 0),
(23, 1, 6, 'Проверка новых модулей', 'content', 23, 0, 2, 1, 0),
...
(2, 'Новости', 'Добавление и изменение новостей', 'News', 0, 12, 1, 'calendar', 1, 1),
...
(6, 0, 'Регистрация модуля', 'Регистрация новых модулей', NULL, 'register_module', 1, NULL, NULL, NULL, 4, 1, 0, '2011-12-25 07:00:01', 1, 0);
...
(24, 'Тип навигации (hierarchy, line)', 'navi_type', 'hierarchy', 1, 0);
...
CREATE TABLE IF NOT EXISTS `kpl_module_recyclebin` (
  ...
  PRIMARY KEY (`rb_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Таблица модуля Module_RecycleBin (Корзина)' AUTO_INCREMENT=1 ;
...
(9, 2, 'Новости', '/Files/admin/icons/calendar/calendar_48.png', 1, 2, '/admin/module/News/'),
